...
plot(hClusters,labels=(df$SiteName), hang = -1)
...
#heatmap(geoDistMathm)          #this and next two to be deleted
...
mant
plot(geoDistMat,chemoTypeDistMat)
...
#ImpVarScaled<-data.Normalization (ImportantVars,type="n7",normalization="column")
